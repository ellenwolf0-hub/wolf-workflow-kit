...
echo "             claude mcp add -s user --transport http slack https://mcp.slack.com/mcp"
echo "             (You'll be prompted to authenticate in your browser)"

# Coda
echo ""
echo "  [Coda]     In Claude Code, run:"
echo "             claude mcp add -s user --transport http Coda https://coda.io/apis/mcp"
...
echo "             2. claude mcp add -s user notebooklm-mcp -- notebooklm-mcp"
echo "                (name must be notebooklm-mcp — the Oracle skills call it by name)"
